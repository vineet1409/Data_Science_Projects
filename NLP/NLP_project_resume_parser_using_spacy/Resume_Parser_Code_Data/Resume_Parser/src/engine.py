...
train= json_spacy.convert_data_to_spacy("D:\\ProjectProd\\Resume_Parser\\input\\training\\Entity Recognition in Resumes.json")
...
predict_model.predict("D:\\ProjectProd\\Resume_Parser\\output\\")
